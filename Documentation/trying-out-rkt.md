...
1. Install rkt:
  * [CoreOS Container Linux][run-cl] comes with rkt installed and configured. You can skip straight to [running a container with rkt][id-rkt-run-by-name].
...
```
wget https://github.com/rkt/rkt/releases/download/v1.29.1/rkt-v1.29.1.tar.gz
tar xzvf rkt-v1.29.1.tar.gz
cd rkt-v1.29.1
./rkt help
```
...
[run-cl]: https://coreos.com/os/docs/latest/#running-coreos
